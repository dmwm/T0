...
#packages ['T0.ConditionUpload', 'T0.JobSplitting', 'T0.RunConfig', 'T0.RunLumiCloseout', 'T0.StorageManager', 'T0.WMBS.Oracle.ConditionUpload', 'T0.WMBS.Oracle.JobSplitting', 'T0.WMBS.Oracle.RunConfig', 'T0.WMBS.Oracle.RunLumiCloseout', 'T0.WMBS.Oracle.SMNotification', 'T0.WMBS.Oracle.StorageManager', 'T0.WMBS.Oracle.Subscriptions', 'T0.WMBS.Oracle.T0DataSvc', 'T0.WMBS.Oracle.Tier0Feeder', 'T0.WMBS.Oracle', 'T0.WMBS', 'T0.WMSpec.StdSpecs', 'T0.WMSpec', 'T0', 'T0Component.Tier0Auditor', 'T0Component.Tier0Feeder', 'T0Component']
#data_files [('/afs/cern.ch/user/y/yulee/pypiwmcore/etc', ['/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/ContainterConfig.sh', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/HIProdOfflineConfiguration.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/HIReplayOfflineConfiguration.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/ProdOfflineConfiguration.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/ReplayOfflineConfiguration.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/ReplayOfflineConfigurationRun1.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/SLSAlarmsConfig.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/Tier0Config.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/XeXeProdOfflineConfiguration.py', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/etc/XeXeReplayOfflineConfiguration.py']), ('/afs/cern.ch/user/y/yulee/pypiwmcore/bin', ['/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/00_deploy.sh', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/00_deploy_prod.sh', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/00_deploy_replay.sh', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/00_patches.sh', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/00_software.sh', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/buildrelease.sh', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/cmst0_backlog_wma', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/cmst0_late_workflows', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/cmst0_long_jobs', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/cmst0_paused_jobs', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/diagnoseActiveRuns', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/forceCloseRuns', '/afs/cern.ch/user/y/yulee/pypiwmcore/source/T0/bin/tier0-mod-config'])]
#package_dir  = {"T0": "src/python/T0", "T0Component": "src/python/T0Component"}

...
#  PhEDEx locations
setAcquisitionEra(tier0Config, "MarchTapeTest2022")
...
DATASETS = ["D01", "D02", "D03", "D04"]
for dataset in DATASETS:
    addDataset(tier0Config, dataset,
            archival_node="T1_DE_KIT_Tape",
            tape_node="T1_FR_CCIN2P3_Tape",
            #disk_node="T0_CH_CERN_Disk",
            #raw_to_disk=False,
            blockCloseDelay=1200,
            timePerEvent=5,
...
DATASETS = ["D05", "D06", "D07", "D08"]
for dataset in DATASETS:
    addDataset(tier0Config, dataset,
            archival_node="T1_RU_JINR_Tape",
            tape_node="T1_UK_RAL_Tape",
            #disk_node="T0_CH_CERN_Disk",
            #raw_to_disk=False,
            blockCloseDelay=1200,
            timePerEvent=5,
...
DATASETS = ["D09", "D10", "D11", "D12", "D13", "D13", "D14", "D15", "D16", "D17"]
for dataset in DATASETS:
    addDataset(tier0Config, dataset,
            #archival_node="T1_RU_JINR_Tape",
            tape_node="T1_US_FNAL_Tape",
            #disk_node="T0_CH_CERN_Disk",
            #raw_to_disk=False,
            blockCloseDelay=1200,
            timePerEvent=5,
...
DATASETS = ["D18", "D19", "D20"]
for dataset in DATASETS:
    addDataset(tier0Config, dataset,
            #archival_node="T1_RU_JINR_Tape",
            tape_node="T1_ES_PIC_Tape",
            #disk_node="T0_CH_CERN_Disk",
            #raw_to_disk=False,
            blockCloseDelay=1200,
            timePerEvent=5,
...
DATASETS = ["D21", "D22", "D23", "D24", "D25"]
for dataset in DATASETS:
    addDataset(tier0Config, dataset,
            #archival_node="T1_RU_JINR_Tape",
            tape_node="T1_IT_CNAF_Tape",
            #disk_node="T0_CH_CERN_Disk",
            #raw_to_disk=False,
            blockCloseDelay=1200,
            timePerEvent=5,
...
ignoreStream(tier0Config, "S26")
ignoreStream(tier0Config, "Parking")
###################################

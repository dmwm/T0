...
RawSkims = {"ReserveDMu0": {"write_dqm" : False}, "ReserveDMu1": {}}
for dataset in DATASETS:
    addDataset(tier0Config, dataset,
               do_reco=True,
               write_dqm=True,
               ...
               tape_node=None,
               raw_skim=list(RawSkims),
               scenario=ppScenario)

    for rawSkim in list(RawSkims):
        addRawSkimDataset(config=tier0Config, rawSkim=rawSkim, parentDataset=dataset, **RawSkims[rawSkim])

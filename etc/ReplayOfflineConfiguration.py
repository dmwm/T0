...
setInjectRuns(tier0Config, [347533])
...
ignoreStream(tier0Config, "S04")
ignoreStream(tier0Config, "S05")
ignoreStream(tier0Config, "S06")
ignoreStream(tier0Config, "S07")
ignoreStream(tier0Config, "S08")
ignoreStream(tier0Config, "S09")
ignoreStream(tier0Config, "S10")
ignoreStream(tier0Config, "S11")
ignoreStream(tier0Config, "S12")
ignoreStream(tier0Config, "S13")

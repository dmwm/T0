...
print("@@--------github.com/gkfthddk/T0----------push@@")
...
print("syntaxerrorcheking)")))#syntax error checking
assert 0, "assert 0 making an error"
...
setInjectRuns(tier0Config, [ 319728 ])
...
defaultProcVersion = 251
expressProcVersion = 251
alcarawProcVersion = 251

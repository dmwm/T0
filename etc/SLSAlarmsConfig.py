...
config.cmst0_backlog_wma.xmlFile = "cmst0-wma-backlog.xml"
config.cmst0_backlog_wma.Express = 2000
config.cmst0_backlog_wma.Repack = 500
...
config.cmst0_long_jobs.xmlFile = "cmst0-long-jobs.xml"
...
config.cmst0_long_jobs.Thresholds.Pending.Repack = 2
config.cmst0_long_jobs.Thresholds.Pending.Merge = 2
...
config.cmst0_long_jobs.Thresholds.Running.Repack = 4
config.cmst0_long_jobs.Thresholds.Running.Merge = 4
config.cmst0_long_jobs.Thresholds.Running.Harvesting = 6
config.cmst0_long_jobs.Thresholds.Running.Processing = 12
...
config.cmst0_long_jobs.Intervention.startTime = "2012-12-05T23:00:00"
...
config.cmst0_paused_jobs.xmlFile = "cmst0-paused-jobs.xml"
config.cmst0_paused_jobs.RunBlacklist = ["000000"]
config.cmst0_paused_jobs.section_("Intervention")
config.cmst0_paused_jobs.Intervention.startTime = "2012-12-05T23:00:00"
